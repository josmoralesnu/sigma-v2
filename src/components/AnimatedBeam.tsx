...
/**
 * AnimatedBeam — un haz de luz que viaja por un path SVG entre dos elementos.
 * Inspirado en el patrón animated-beam (ui-layouts / magicui).
 */
export function AnimatedBeam({
  ...
  pathWidth = 1.5,
  pathOpacity = 0.12,
  gradientStartColor = "#cf4d6b",
  gradientStopColor = "#c79a52",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
  ...
  useEffect(() => {
    ...
    const t = setTimeout(updatePath, 60);
